      ...
      <section className="tt-scc-section">
        ...
        padding: "0 24px"
          ...
          <motion.div {...fadeUp(0.1)} className="tt-scc-card">
            ...
            {/* Map */}
            <iframe title="TechnoTV Location"
          ...
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3777.795948121903!2d79.47166907475636!3d18.76264938237851!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a32ce9c5ca19d75%3A0xbd503add23ac3ef5!2sVASU%20ELECTRONICS%20F%26D%20LED!5e0!3m2!1sen!2sin!4v1773137688612!5m2!1sen!2sin" className="tt-scc-map" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
            ...
            <div className="tt-scc-body">
              ...
              <div className="tt-scc-open">
                <span className="tt-scc-pulse" style={{
                width: 6,
                height: 6,
                borderRadius: "50%",
                background: "#16A34A",
              ...
              <div className="tt-scc-row">
                <div className="tt-scc-ib"><MapPin size={14} style={{
                  color: "var(--accent, #1A5FBF)"
                }} /></div>
              ...
              <div className="tt-scc-row">
                <div className="tt-scc-ib"><Clock size={14} style={{
                  color: "var(--accent, #1A5FBF)"
                }} /></div>
              ...
              <a href="tel:+919912172878" className="tt-scc-row">
                <div className="tt-scc-ib"><Phone size={14} style={{
                  color: "var(--accent, #1A5FBF)"
                }} /></div>
              ...
              <a href="mailto:vasuelectronics97@gmail.com" className="tt-scc-row">
                <div className="tt-scc-ib"><Mail size={14} style={{
                  color: "var(--accent, #1A5FBF)"
                }} /></div>
              ...
              {/* Directions CTA */}
              <a href="https://www.google.com/maps/dir//Peddapalli,+Telangana" target="_blank" rel="noopener noreferrer" className="tt-scc-btn">
                <Navigation size={16} />
                Get Directions
              </a>
            </div>
