...
const Footer = () => {
  ...
  return <>
      ...
      <footer className="tt-footer tt-footer-grid" data-theme={dark ? "dark" : "light"} style={{
      ...
      overflow: "hidden"
        ...
        zIndex: 1
          ...
          {/* ── Columns ─────────────────────────────────────── */}
          <div className="tt-footer-cols" style={{
          marginBottom: 52
        }}>
            ...
            <div>
              ...
              <div className="tt-footer-hours">
                <span className="tt-footer-dot" style={{
                width: 6,
                height: 6,
                borderRadius: "50%",
                background: "#4ADE80",
            ...
            <div>
              ...
              gap: 10
                ...
                path: "/contact"
                    ...
                    <Link href={link.path} className="tt-footer-link">
              ...
              gap: 13
                ...
                <li>
                  <div className="tt-footer-contact">
                    <div className="tt-footer-ib"><MapPin size={13} style={{
                ...
                <li>
                  <a href="tel:+919912172878" className="tt-footer-contact">
                    <div className="tt-footer-ib"><Phone size={13} style={{
                      color: "var(--footer-accent)"
                    }} /></div>
                    +91 99121 72878
                  </a>
                ...
                <li>
                  <a href="mailto:vasuelectronics97@gmail.com" className="tt-footer-contact">
                    <div className="tt-footer-ib"><Mail size={13} style={{
                      color: "var(--footer-accent)"
                    }} /></div>
                ...
                <li>
                  <div className="tt-footer-contact">
                    <div className="tt-footer-ib"><Clock size={13} style={{
                      color: "var(--footer-accent)"
                    }} /></div>
            ...
            <div>
              ...
              marginBottom: 18
                ...
                {["Peddapalli", "Mancherial", "Ramagundam", "Sultanabad", "Godavarikhani"].map(area => <span key={area} className="tt-footer-chip">{area}</span>)}
              </div>
              <a href="https://www.google.com/maps/dir//Peddapalli,+Telangana" target="_blank" rel="noopener noreferrer" className="tt-footer-maps">
          ...
          gap: 12
            ...
            <span className="tt-footer-btm" style={{
            color: "var(--footer-tx3)",
            cursor: "default"
          }}>
            ...
            gap: 20
              ...
              {["Privacy Policy", "Terms of Service"].map(t => <a key={t} href="#" className="tt-footer-btm">{t}</a>)}
            </div>
          </div>
        </div>
      </footer>
