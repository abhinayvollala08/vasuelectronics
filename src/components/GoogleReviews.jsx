...
const reviews = [{
  name: "Rajesh Kumar",
  rating: 5,
  text: "Excellent service! My LED TV was repaired within a day. Very professional team.",
  time: "2 weeks ago"
}, {
  name: "Priya Sharma",
  rating: 5,
  text: "Best service center in Peddapalli. They used genuine parts and the TV works perfectly now.",
  time: "1 month ago"
}, {
  name: "Suresh Reddy",
  rating: 4,
  text: "Good experience with their AC repair service. Reasonable pricing and quick turnaround.",
  time: "3 weeks ago"
}, {
  name: "Anita Devi",
  rating: 5,
  text: "Very reliable and trustworthy. Fixed my washing machine issue which other shops couldn't.",
  time: "2 months ago"
}, {
  name: "Venkat Rao",
  rating: 5,
  text: "Home theater installation was done perfectly. Great sound quality setup. Highly recommend!",
  time: "1 month ago"
}, {
  name: "Lakshmi Bai",
  rating: 4,
  text: "Prompt service for my refrigerator. The technician was knowledgeable and polite.",
  time: "3 months ago"
}];
...
const avatarColors = [{
  bg: "rgba(27,101,200,.13)",
  color: "#1B65C8"
}, {
  bg: "rgba(16,163,74,.12)",
  color: "#16A34A"
}, {
          ...
          <div className="tt-gr-stats-row">
            ...
            <div className="tt-gr-stat">
              <div style={{
                ...
                borderRadius: 9,
                background: "var(--accent-lt, #EBF3FF)",
                border: "1px solid var(--accent-bd, #C0D9FF)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                flexShrink: 0
