...
import { Phone, Tv, Wrench, Wind, ShieldCheck, Clock, Star, ArrowRight, CheckCircle, MapPin, ChevronRight, Zap, Award, Users } from "lucide-react";
...
const services = [{
  Icon: Tv,
  title: "TV Repair",
  desc: "LED, LCD & Plasma TVs — screen, board, backlight and power fault diagnosis."
}, {
  Icon: Wind,
  title: "AC Servicing",
  desc: "Deep cleaning, gas refill, compressor & PCB repair for all major brands."
}, {
  Icon: Wrench,
  title: "Refrigerator Repair",
  desc: "Cooling issues, compressor faults, gas leaks — fully diagnosed and resolved."
}, {
  Icon: Zap,
  title: "Washing Machine",
  desc: "Front-load & top-load: drum, motor, PCB & inlet valve repairs."
}, {
  Icon: Star,
  title: "Home Theatre",
  desc: "Installation, calibration and surround-sound system setup at your home."
}, {
  Icon: ShieldCheck,
  title: "AMC Contracts",
  desc: "Annual maintenance plans for homes, offices and businesses."
}];
const pillars = [{
  Icon: ShieldCheck,
  title: "Genuine Parts Only",
  desc: "We source OEM-certified components — no cheap substitutes, ever."
}, {
  Icon: Clock,
  title: "Same-Day Response",
  desc: "Call before noon; our technician arrives the same day."
}, {
  Icon: Users,
  title: "Certified Technicians",
  desc: "Factory-trained, brand-authorized engineers on every job."
}, {
  Icon: MapPin,
  title: "Doorstep Service",
  desc: "Peddapalli & Mancherial districts — we come to you."
}];
const reasons = ["Transparent pricing quoted before any work starts", "Post-repair warranty on every single job", "Over 5,000 successful repairs across 15+ brands", "Punctual technicians who respect your home", "Genuine spare parts with serial-number traceability", "One trusted contact for all your appliance needs"];
    ...
    <div className="tt" data-theme={dark ? "dark" : "light"}>
      ...
      <section className="tt-sec" style={{
        ...
        <div className="tt-wrap">
          <motion.div {...fadeUp(0)} className="tt-sec-head">
            <div>
              ...
              <h2 className="tt-serif" style={{
                ...
                color: "var(--tx1)",
                lineHeight: 1.15
              }}>Complete Appliance Care</h2>
            </div>
            <Link href="/services" className="tt-ul" style={{
              fontSize: ".85rem",
              display: "flex",
              alignItems: "center",
              gap: 4,
          ...
          <div className="tt-g3">
            {services.map((svc, i) => <motion.div key={i} {...fadeUp(i * 0.065)} className="tt-card tt-card-hover" style={{
              padding: "26px 24px"
            }}>
      ...
      <section className="tt-sec" style={{
        ...
        <div className="tt-wrap" style={{
          ...
          <div className="tt-about-grid">
            <motion.div {...fadeUp(0)}>
              <span className="tt-lbl">About Vasu Electronics</span>
              <h2 className="tt-serif" style={{
                fontSize: "clamp(1.7rem,3.6vw,2.5rem)",
                color: "var(--tx1)",
                marginBottom: 20,
                lineHeight: 1.15
              }}>A Decade of<br />Trusted Repairs</h2>
              <p style={{
                fontSize: ".93rem",
                lineHeight: 1.82,
                color: "var(--tx2)",
                ...
                Since 2014, Vasu Electronics has been the go-to authorised service center across Peddapalli and Mancherial
              ...
              <div style={{
                ...
                {reasons.map((r, i) => <motion.div key={i} initial={{
                  opacity: 0,
                  x: -10
                }} whileInView={{
                  opacity: 1,
            ...
            <motion.div {...fadeUp(0.13)} style={{
              ...
              {pillars.map((p, i) => <motion.div key={i} {...fadeUp(0.08 + i * 0.07)} className="tt-card tt-card-hover" style={{
                padding: "20px 18px",
                display: "flex",
                gap: 14,
                alignItems: "flex-start"
              }}>
                <div className="tt-ib"><p.Icon size={18} style={{
                  color: "var(--accent)"
                }} /></div>
                <div>
                  <h4 style={{
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    color: "var(--tx3)",
                    lineHeight: 1.6
                  }}>All repairs backed by a written post-service warranty. Your peace of mind is guaranteed.</div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section style={{
        ...
        <div style={{
          ...
          width: "65%",
          height: "240%",
          background: "radial-gradient(ellipse, rgba(255,255,255,.1) 0%, transparent 58%)",
          pointerEvents: "none"
        }} />
        <div className="tt-wrap" style={{
          position: "relative",
          ...
          <motion.div {...fadeUp(0)}>
            ...
            <h2 className="tt-serif" style={{
              ...
              marginBottom: 16,
              lineHeight: 1.1
            }}>Ready to Fix Your Appliance?</h2>
            <p style={{
              fontSize: ".95rem",
            ...
            <div style={{
              ...
              {["Free Diagnosis", "Warranty on Repairs", "No Hidden Charges"].map((t, i) => <span key={i} style={{
                display: "flex",
                alignItems: "center",
                gap: 5,
                fontSize: ".77rem",
