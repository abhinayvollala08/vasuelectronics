...
const contactInfo = [{
  Icon: MapPin,
  label: "Visit Us",
  value: "Peddapalli & Mancherial Districts, Telangana, India",
  href: undefined
}, {
  Icon: Phone,
  label: "Call Us",
  value: "+91 99121 72878",
  href: "tel:+919876543210"
}, {
  Icon: Mail,
  label: "Email Us",
  value: "vasuelectronics97@gmail.com",
  href: "mailto:vasuelectronics97@gmail.com"
}, {
  Icon: Clock,
  label: "Working Hours",
            ...
            <div className="tt-contact-hero">
              ...
              <motion.div {...fadeUp(0)}>
                ...
                maxWidth: 440
                  ...
                  color: "var(--tx1)",
                  fontWeight: 600
                }}>Peddapalli &amp; Mancherial</strong> — same-day response available.
                </p>
                ...
                flexWrap: "wrap"
                  ...
                  <a href="mailto:vasuelectronics97@gmail.com" style={{
                  display: "inline-flex",
                  alignItems: "center",
                  gap: 7,
              ...
              <motion.div {...fadeUp(0.13)}>
                ...
                padding: 12
                  ...
                  gap: 10
                    ...
                    {contactInfo.map((item, i) => <div key={i} style={{
                    display: "flex",
                    alignItems: "center",
                    gap: 14,
                    padding: "14px 16px",
                    ...
                    border: "1px solid var(--border)"
                      ...
                      flexShrink: 0
                        ...
                        marginBottom: 3
                          ...
                          {item.href ? <a href={item.href} style={{
                        fontSize: ".88rem",
                        fontWeight: 500,
                        color: "var(--accent)",
                        textDecoration: "none"
                      }}>{item.value}</a> : <span style={{
                        fontSize: ".88rem",
                        fontWeight: 500,
                        color: "var(--tx1)"
                      }}>{item.value}</span>}
...
<section className="tt-sec" style={{
  ...
  <div className="tt-wrap" style={{
    ...
    <motion.div {...fadeUp(0.2)} style={{
      ...
      <iframe title="Location Map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d121554.8076!2d79.32!3d18.62!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcce04cf79f4189%3A0x7b0c3c91f5a4c057!2sPeddapalli%2C%20Telangana!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" width="100%" height="100%" style={{
              border: 0
