...
const values = [{
  ...
  desc: "Every repair is handled with care, ensuring complete customer satisfaction from start to finish."
}, {
  Icon: Target,
  title: "Precision & Quality",
  desc: "We use advanced diagnostic tools and genuine OEM spare parts for every single repair."
}, {
  Icon: CheckCircle,
  title: "Transparency",
  desc: "Clear pricing with no hidden charges. We explain every issue and quote before work begins."
}, {
  Icon: Award,
  title: "Certified Experts",
  desc: "Our technicians are factory-trained and certified by leading international brands."
}];
const milestones = [{
  year: "2014",
  title: "Founded in Peddapalli",
  desc: "Started as a single TV repair workshop with a vision for honest, community-first service."
}, {
  year: "2017",
  title: "Multi-Brand Authorization",
  desc: "Earned authorized service center status for five leading electronics brands."
}, {
  year: "2020",
  title: "Mancherial Expansion",
  desc: "Extended full doorstep service coverage to the entire Mancherial district."
}, {
  year: "2024",
  title: "15+ Brands & 5,000+ Repairs",
  desc: "A decade of trust — now covering ACs, washing machines, refrigerators & home theatres."
}];
      ...
      <div className="tt" data-theme={dark ? "dark" : "light"}>
        ...
        overflow: "hidden"
          ...
          zIndex: 1
            ...
            }].map((item, i) => <motion.div key={i} {...fadeUp(i * 0.07)} className="tt-card tt-card-hover" style={{
              padding: "26px 22px",
              textAlign: "center"
            }}>
                  <div style={{
