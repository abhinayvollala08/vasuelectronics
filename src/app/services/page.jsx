...
import { Tv, Speaker, Snowflake, WashingMachine, Refrigerator, Monitor, Cpu, Plug, CheckCircle, Phone, ArrowRight, ShieldCheck, Clock, Wrench, Zap } from "lucide-react";
...
const steps = [{
  ...
  Icon: Phone,
  title: "Contact Us",
  desc: "Call us or fill the contact form for a free consultation — no obligation."
}, {
  step: "02",
  Icon: Zap,
  title: "Diagnosis",
  desc: "Our expert technicians diagnose the fault thoroughly on-site."
}, {
  step: "03",
  Icon: Wrench,
  title: "Repair",
  desc: "We fix it using genuine OEM parts and proven repair techniques."
}, {
  step: "04",
  Icon: ShieldCheck,
  title: "Warranty",
  desc: "Your repaired appliance is handed back with a written service warranty."
}];
            ...
            <div className="tt-svc-hero">
              ...
              <motion.div {...fadeUp(0)}>
                ...
                maxWidth: 460
                  ...
                  we repair it all with <strong style={{
                  color: "var(--tx1)",
                  fontWeight: 600
                }}>genuine parts</strong> and
                  expert care across Peddapalli &amp; Mancherial.
                </p>
                <div className="tt-hero-ctas" style={{
                display: "flex",
                gap: 12,
                flexWrap: "wrap"
              }}>
                  <a href="tel:+919912172878" className="tt-btn-p" style={{
                  display: "inline-flex",
                  alignItems: "center",
                  gap: 8,
                  background: "var(--accent)",
                  ...
                  borderRadius: 10,
                  textDecoration: "none",
                  boxShadow: "0 4px 16px rgba(26,95,191,.28)",
                  whiteSpace: "nowrap"
                }}>
              ...
              <motion.div {...fadeUp(0.13)}>
                ...
                padding: 14
                  ...
                  gap: 10
                    ...
                    sub: "No cheap substitutes — ever"
                  }, {
                    Icon: Clock,
                    label: "Same-Day Response",
                    sub: "Call before noon, we arrive today"
                  }, {
                    Icon: Wrench,
                    label: "Certified Technicians",
                    sub: "Factory-trained, brand-authorized"
                  }, {
                    Icon: CheckCircle,
                    label: "Post-Repair Warranty",
                    sub: "Written guarantee on every job"
        ...
        background: "var(--bg)"
          ...
          <div className="tt-wrap">
            ...
            <div className="tt-svc-grid">
              {services.map((svc, i) => <motion.div key={i} {...fadeUp(i * 0.055)} className="tt-card tt-card-hover" style={{
              padding: "26px 24px"
            }}>
                ...
                alignItems: "flex-start"
                  ...
                  flex: 1
                    ...
                    gap: "6px 14px"
                        ...
                        {svc.features.map((f, j) => <span key={j} style={{
                      display: "flex",
                      alignItems: "center",
                      gap: 5,
                      fontSize: ".76rem",
        ...
        overflow: "hidden"
          ...
          zIndex: 1
            ...
            <div className="tt-steps-grid">
              {steps.map((s, i) => <motion.div key={i} {...fadeUp(i * 0.08)} className="tt-card tt-card-hover" style={{
              padding: "28px 22px"
            }}>
                  <div className="tt-dots" style={{
                position: "absolute",
